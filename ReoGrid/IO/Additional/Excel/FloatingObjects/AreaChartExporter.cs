...
#warning <c:crosses val="autoZero"/> пропущен
        ...
        private static CT_ValAx CreateValAx(CT_UnsignedInt id, CT_UnsignedInt crossId, ST_Orientation reverseOrderCategories)
        {
            return new CT_ValAx
            {
                axId = id,
                scaling = new CT_Scaling { orientation = new CT_Orientation { val = reverseOrderCategories } },
